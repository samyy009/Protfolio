    ...
    <footer className="bg-slate-950 border-t border-slate-900 py-12 text-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-slate-500 max-w-md mx-auto mb-8">
          Crafting high-quality digital experiences with modern web technologies.
        </p>
        <div className="flex justify-center space-x-8 mb-8">
          <a href="https://github.com/samyy009" className="text-slate-500 hover:text-white transition-colors">
        ...
        <p className="text-slate-600 text-sm">
          &copy; {new Date().getFullYear()} Sameer Sangam. All rights reserved.
        </p>
      </div>
    </footer>
  );
