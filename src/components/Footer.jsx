      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex justify-center gap-6 mb-10">
          <a href="https://github.com/samyy009" target="_blank" rel="noopener noreferrer"
            className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-orange-400 hover:border-orange-500/40 transition-all">
